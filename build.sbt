//
// File: https://github.com/bom4v/ti-spark-data-generation/blob/master/build.sbt
//
...
homepage := Some(url("https://github.com/bom4v/ti-spark-data-generation"))
startYear := Some(2019)
description := "Generation of a few sample data sets. For instance, feature set derived from CDR"
licenses += "Apache-2.0" -> url("https://www.apache.org/licenses/LICENSE-2.0")

scmInfo := Some(
  ScmInfo(
    url("https://github.com/bom4v/ti-spark-data-generation"),
    "https://github.com/bom4v/ti-spark-data-generation.git"
  )
)
